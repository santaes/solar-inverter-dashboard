...
from .config import (
    ...
    CONNECTION_MODE,
    COUNTED_VISITOR_COOKIE,
    DEVICE,
    FAVICON_PATH,
    MADRID_TIME_ZONE,
    MANUAL_REGISTER_VALUES_PATH,
    PROJECT_ROOT,
    REGISTER_LOG_CLEANUP_TARGET_BYTES,
    REGISTER_LOG_DIRECTORY,
    REGISTER_LOG_MIN_FREE_BYTES,
    REGISTER_MAP_MAX_BYTES,
    REGISTER_MAP_PATH,
    SLAVE_ID,
    STATS_DB_PATH,
    TCP_IP,
...
from .register_overrides import *

configure_register_catalog(REGISTER_CONFIG, KNOWN_REGISTERS)
...
METER_DEFINITIONS = [
    ...
    (134, [404, 405], "Потужність акумулятора", -15000.0, 15000.0, "W"),
